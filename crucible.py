...
# Sample:
# crucible.py CR --title "your title" @reviewer1 @reviewer2
...
class Configuration(object):
    ...
    def fill_from_defaults(self):
        self.url, self.username = self.url or 'http://fisheye01.peoplenetonline.com:8060', self.username or 'azirbes'
        return self
